...
(site_out / 'index.html').write_text(index_tpl.render(cfg=CFG, deals=home_deals), encoding='utf-8')
...
for c in CFG['site']['categories']:
    ...
    (out_dir / 'index.html').write_text(cat_tpl.render(cfg=CFG, cat=c, deals=cd), encoding='utf-8')
